...
7// Crea un nuevo dataframe con una columna llamada "HV Ratio" que es la relación entre precio de la columna "High" frente a columna "volumen" de acciones negociadas por un día.
...
println("Son los valores de cierre de las acciones de Netflix durante los dias analizados")
...
//a ¿Cuántos días fue columna "Close" inferior a $600?
